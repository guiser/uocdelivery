jQuery("#simulation")
  .on("click", ".s-79b21577-b9b1-4b12-8742-11a7dde1989f .click", function(event, data) {
  ...
  .on("pageload", ".s-79b21577-b9b1-4b12-8742-11a7dde1989f .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
